        ...
        <div className="flex flex-col space-y-6 md:space-y-10">
          ...
          <div>
            <motion.button
              ...
              className="px-6 md:px-[49px] py-4 md:py-[21px] text-base md:text-[20px] font-bold text-white bg-white/15 hover:bg-white/20 transition-colors duration-300 rounded-full"
