    ...
    <div className="relative flex flex-col items-center" ref={ref}>
      ...
      <div className="absolute top-0 w-full flex flex-col items-center z-10 mt-[53px] lg:mt-[120px]">
        ...
        <div className="relative text-center">
          <h1 className="text-[28.16px] lg:text-[50px] font-bold font-Montserrat leading-[33.8px] lg:leading-[60px]">
        ...
        {/* Description */}
        <p className="mt-[14.64px] lg:mt-[26px] text-[11.26px] lg:text-[20px] font-Montserrat leading-[16.9px] lg:leading-[30px] text-center text-[#5C5B5B]">
