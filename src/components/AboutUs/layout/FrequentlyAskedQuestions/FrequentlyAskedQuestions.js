...
const FrequentlyAskedQuestions = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-[28px] lg:text-[50px] font-bold font-Montserrat leading-tight sm:leading-snug lg:leading-none">
      ...
      <motion.p
        ...
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, ease: "easeOut" }}
        className="mt-[21.89px] lg:mt-[38px] text-[11.52px] lg:text-[20px] font-Montserrat text-center text-[#5C5B5B] w-[413.57px] lg:w-[718px] mx-auto"
      >
